...
<head>
  ...
  <title>MYBOOK page d'Etudiant</title>
...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="etudiant.jsp "class="logo"><b>MY<span>BOOK</span></b></a>
      <!--logo end-->
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              ...
              <span class="ssitem">Lister Livres</span>
              </a>
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              ...
              <span class="ssitem">Rerserver Livre</span>
              </a>
  ...
  <!--main content   start-->
			   <section id="main-content">
		        ...
		        <div class="col-md-12  mt" id="liste livre">
