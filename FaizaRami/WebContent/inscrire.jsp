    ...
    <div class="container">
      <form class="form-login" action="Inscription" method="post">
        ...
        <div class="login-wrap">
          ...
          <br>
          <input type="text" class="form-control" name="prenom" placeholder="Votre Prenom" autofocus>
          <br>
          <input type="email" class="form-control" name="email" placeholder="Votre adresse email" autofocus>
          <br>
          ...
          <div class="registration">
           vous êtes déjà inscrit?<br/>
            <a class="" href="http://localhost:8282/FaizaRami/authentification.jsp">
              S'authentifier
              </a>
          </div>
        </div>
